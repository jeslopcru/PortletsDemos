...
import com.jesuslc.demos.browntasks.service.TaskListLocalService;
import com.jesuslc.demos.browntasks.service.persistence.TaskItemPersistence;
import com.jesuslc.demos.browntasks.service.persistence.TaskListPersistence;
...
/**
 * The base implementation of the task list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.jesuslc.demos.browntasks.service.impl.TaskListLocalServiceImpl}.
 * </p>
 *
 * @author Jesus
 * @see com.jesuslc.demos.browntasks.service.impl.TaskListLocalServiceImpl
 * @see com.jesuslc.demos.browntasks.service.TaskListLocalServiceUtil
 * @generated
 */
public abstract class TaskListLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.jesuslc.demos.browntasks.service.TaskListLocalServiceUtil} to access the task list local service.
	 */
	...
	public TaskList addTaskList(TaskList taskList) throws SystemException {
		...
		return taskListPersistence.update(taskList, false);
	}
	...
	public TaskList updateTaskList(TaskList taskList) throws SystemException {
		return updateTaskList(taskList, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TaskList updateTaskList(TaskList taskList, boolean merge)
		throws SystemException {
		taskList.setNew(false);

		return taskListPersistence.update(taskList, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.jesuslc.demos.browntasks.model.TaskList",

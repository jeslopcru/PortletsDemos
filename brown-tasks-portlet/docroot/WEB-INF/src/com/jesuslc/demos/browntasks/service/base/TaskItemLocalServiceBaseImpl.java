...
/**
 * The base implementation of the task item local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.jesuslc.demos.browntasks.service.impl.TaskItemLocalServiceImpl}.
 * </p>
 *
 * @author Jesus
...
public abstract class TaskItemLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.jesuslc.demos.browntasks.service.TaskItemLocalServiceUtil} to access the task item local service.
	 */
	...
	public TaskItem addTaskItem(TaskItem taskItem) throws SystemException {
		...
		return taskItemPersistence.update(taskItem, false);
	}
	...
	public TaskItem updateTaskItem(TaskItem taskItem) throws SystemException {
		return updateTaskItem(taskItem, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TaskItem updateTaskItem(TaskItem taskItem, boolean merge)
		throws SystemException {
		taskItem.setNew(false);

		return taskItemPersistence.update(taskItem, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.jesuslc.demos.browntasks.model.TaskItem",
